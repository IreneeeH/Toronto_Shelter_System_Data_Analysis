...
#| tbl-cap: "Sample of Toronto Shelter Flow Statistics from 2018 to 2023"
#| echo: false

cleaned_toronto_shelters_data |>
  slice(1:14) |>
  kable(col.names = c("Date", "Population Group", "Returned from Housing", "New to Shelter", "Actively Homeless", "Males", "Females"))
```
